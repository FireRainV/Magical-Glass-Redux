local LightEnemyTensionBarGlow, super = Class(Object)

function LightEnemyTensionBarGlow:init(x, y)
    super.init(self, x, y)
...
function LightEnemyTensionBarGlow:update()
    super.update(self)
...
function LightEnemyTensionBarGlow:draw()
...
return LightEnemyTensionBarGlow
