local spell, super = Class(Spell, "shootingstar")
...
function spell:init()
    ...
    self.effect = "Random\nTarget"
    -- Menu description
    self.description = "Drops a magical Star onto a\nrandom enemy."
    self.check = "Drops magical star onto a random enemy."
...
function spell:onCast(user, target)
    ...
    local target = Utils.pick(Game.battle:getActiveEnemies())
